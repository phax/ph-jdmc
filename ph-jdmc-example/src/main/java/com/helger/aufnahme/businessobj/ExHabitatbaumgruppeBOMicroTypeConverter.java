 ...
 */
public class ExHabitatbaumgruppeBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExHabitatbaumgruppeBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExHabitatbaumgruppeBO aValue,
  ...
  public ExHabitatbaumgruppeBO convertToNative (@Nonnull final IMicroElement aElement)
  {
    ...
    return new ExHabitatbaumgruppeBO (super.getStubObject (aElement),
                                      nHBGNr,
                                      aPics,
                                      aHBGzBB,
                                      aDate,
