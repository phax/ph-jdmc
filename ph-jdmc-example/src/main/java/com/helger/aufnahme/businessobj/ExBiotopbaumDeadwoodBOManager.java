 ...
 * {@link com.helger.aufnahme.businessobj.ExBiotopbaumDeadwoodBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExBiotopbaumDeadwoodBOManager extends AbstractPhotonMapBasedWALDAO <IExBiotopbaumDeadwoodBO, ExBiotopbaumDeadwoodBO>
{

  public ExBiotopbaumDeadwoodBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExBiotopbaumDeadwoodBO.class, sFilename);
  }

  public ExBiotopbaumDeadwoodBOManager (@Nullable final String sFilename,
                                        @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExBiotopbaumDeadwoodBO> aInitSettings) throws DAOException
  {
                                                                     ...
                                                                     final int nBHD)
  {
    ...
    // Success audit
    AuditHelper.onAuditCreateSuccess (ExBiotopbaumDeadwoodBO.OT,
                                      aExBiotopbaumDeadwoodBO.getID (),
                                      eType,
                                                     ...
                                                     final int nBHD)
  {
    ...
    // Success audit
    AuditHelper.onAuditModifySuccess (ExBiotopbaumDeadwoodBO.OT,
                                      "all",
                                      aExBiotopbaumDeadwoodBO.getID (),
                                      eType,
                                      Boolean.valueOf (bEnabled),
   ...
   * {@link #markExBiotopbaumDeadwoodBOUndeleted(String)} method.
   * 
   * @param sExBiotopbaumDeadwoodBOID
   ...
   * {@link #markExBiotopbaumDeadwoodBODeleted(String)} method.
   * 
   * @param sExBiotopbaumDeadwoodBOID
