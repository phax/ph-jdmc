...
public final class MicroTypeConverterRegistrar implements IMicroTypeConverterRegistrarSPI
{
  ...
  public void registerMicroTypeConverter (@Nonnull final IMicroTypeConverterRegistry aRegistry)
  {
    ...
    aRegistry.registerMicroElementTypeConverter (ExBiotopbaumDecompositionDegreeBO.class,
                                                 new ExBiotopbaumDecompositionDegreeBOMicroTypeConverter ());
    ...
    // Registration of com.helger.aufnahme.businessobj.ExStichprobeBO must be
    // done manually!
