 ...
 */
public class ExBestandBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExBestandBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExBestandBO aValue,
  ...
  public ExBestandBO convertToNative (@Nonnull final IMicroElement aElement)
  {
    ...
    return new ExBestandBO (super.getStubObject (aElement),
                            nBNr,
                            aPics,
                            aDate,
                            sVerortung,
