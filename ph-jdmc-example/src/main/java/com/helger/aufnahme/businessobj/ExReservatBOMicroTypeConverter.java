 ...
 */
public class ExReservatBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExReservatBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExReservatBO aValue,
