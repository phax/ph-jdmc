...
/**
 * <p>
 * Interface for class {@link ExBiotopbaumBO}
 * </p>
 * <p>
 ...
 */
public interface IExBiotopbaumBO extends IBusinessObject
{
  ...
  /**
   * Höhlentyp und Anzahl mit Klasseneinteilung (Checkbox, mehrere möglich; dann
   * noch Klassenangaben; C22-35 im Aufnahmemanual)
   * 
   * @return The requested value. May not be <code>null</code>.
   */
  @Nonnull
