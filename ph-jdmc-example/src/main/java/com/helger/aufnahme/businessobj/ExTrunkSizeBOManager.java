 ...
 * {@link com.helger.aufnahme.businessobj.ExTrunkSizeBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExTrunkSizeBOManager extends AbstractPhotonMapBasedWALDAO <IExTrunkSizeBO, ExTrunkSizeBO>
{

  public ExTrunkSizeBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExTrunkSizeBO.class, sFilename);
  }

  public ExTrunkSizeBOManager (@Nullable final String sFilename,
                               @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExTrunkSizeBO> aInitSettings) throws DAOException
  {
   ...
   * and can be restored using the {@link #markExTrunkSizeBOUndeleted(String)}
   * method.
   * 
   * @param sExTrunkSizeBOID
   ...
   * {@link #markExTrunkSizeBODeleted(String)} method.
   * 
   * @param sExTrunkSizeBOID
