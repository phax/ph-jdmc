 ...
 */
@ThreadSafe
public class ExBiotopbaumDecompositionDegreeBOManager extends
                                                      AbstractPhotonMapBasedWALDAO <IExBiotopbaumDecompositionDegreeBO, ExBiotopbaumDecompositionDegreeBO>
{

  public ExBiotopbaumDecompositionDegreeBOManager (@Nullable final String sFilename) throws DAOException
  {
  ...
  public ExBiotopbaumDecompositionDegreeBOManager (@Nullable final String sFilename,
                                                   @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExBiotopbaumDecompositionDegreeBO> aInitSettings) throws DAOException
  {
  ...
  {
    // Create new object
    final ExBiotopbaumDecompositionDegreeBO aExBiotopbaumDecompositionDegreeBO = new ExBiotopbaumDecompositionDegreeBO (eType,
                                                                                                                        bEnabled,
                                                                                                                        nLength,
                                                                                                                        nBHD);
    // Save internally
    ...
    // Success audit
    AuditHelper.onAuditCreateSuccess (ExBiotopbaumDecompositionDegreeBO.OT,
                                      aExBiotopbaumDecompositionDegreeBO.getID (),
                                      eType,
                                      Boolean.valueOf (bEnabled),
                                      Integer.valueOf (nLength),
                                      Integer.valueOf (nBHD));
                                                                ...
                                                                final int nBHD)
  {
    ...
    {
      AuditHelper.onAuditModifyFailure (ExBiotopbaumDecompositionDegreeBO.OT,
                                        "all",
                                        sExBiotopbaumDecompositionDegreeBOID,
                                        "already-deleted");
      return EChange.UNCHANGED;
    }
    // Update internally
    ...
    // Success audit
    AuditHelper.onAuditModifySuccess (ExBiotopbaumDecompositionDegreeBO.OT,
                                      "all",
                                      aExBiotopbaumDecompositionDegreeBO.getID (),
                                      eType,
                                      Boolean.valueOf (bEnabled),
   ...
   * {@link #markExBiotopbaumDecompositionDegreeBOUndeleted(String)} method.
   * 
   * @param sExBiotopbaumDecompositionDegreeBOID
   ...
   * {@link #markExBiotopbaumDecompositionDegreeBODeleted(String)} method.
   * 
   * @param sExBiotopbaumDecompositionDegreeBOID
