 ...
 * {@link com.helger.aufnahme.businessobj.ExCaveTypeBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExCaveTypeBOManager extends AbstractPhotonMapBasedWALDAO <IExCaveTypeBO, ExCaveTypeBO>
{

  public ExCaveTypeBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExCaveTypeBO.class, sFilename);
  }

  public ExCaveTypeBOManager (@Nullable final String sFilename,
                              @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExCaveTypeBO> aInitSettings) throws DAOException
  {
   ...
   */
  @Nonnull
  public final EChange updateExCaveTypeBO (@Nullable final String sExCaveTypeBOID,
                                           @Nonnull final EExCaveClassBO eClazz,
                                           @Nonnull final EExCaveTypeBO eType)
  {
   ...
   * and can be restored using the {@link #markExCaveTypeBOUndeleted(String)}
   * method.
   * 
   * @param sExCaveTypeBOID
   ...
   * {@link #markExCaveTypeBODeleted(String)} method.
   * 
   * @param sExCaveTypeBOID
