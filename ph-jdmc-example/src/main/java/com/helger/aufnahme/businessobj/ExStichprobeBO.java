 ...
 * {@link com.helger.aufnahme.businessobj.IExStichprobeBO}
 * </p>
 * <p>
 ...
 */
@NotThreadSafe
public class ExStichprobeBO extends AbstractBusinessObject implements IExStichprobeBO
{
  public static final ObjectType OT = new ObjectType ("ExStichprobeBO");
  private int m_nStichNr;
  private IExReservatBO m_aStichNrzR;
  ...
  private final ICommonsList <IExBiotopbaumBO> m_aTrees = new CommonsArrayList <> ();
  private String m_sDesc;
  private boolean m_bSameAge;
  private boolean m_bOneLevel;
  private final ICommonsList <IExStichprobeDeadwoodBO> m_aTotSteh = new CommonsArrayList <> ();
  private final ICommonsList <IExStichprobeDeadwoodBO> m_aTotLieg1 = new CommonsArrayList <> ();
  private final ICommonsList <IExStichprobeDeadwoodBO> m_aTotLieg2 = new CommonsArrayList <> ();

  public ExStichprobeBO (final int nStichNr,
  ...
  protected ExStichprobeBO (@Nonnull final StubObject aStubObject,
                            final int nStichNr,
                            @Nonnull final IExReservatBO aStichNrzR,
                            @Nonnull @Nonempty final ICommonsList <File> aPics,
                            @Nonnull final LocalDate aDate,
  ...
  public String toString ()
  {
    return ToStringGenerator.getDerived (super.toString ())
                            .append ("StichNr", m_nStichNr)
                            .append ("StichNrzR", m_aStichNrzR)
                            .append ("pics", m_aPics)
                            .append ("date", m_aDate)
                            .append ("size", m_nSize)
                            ...
                            .append ("BKL8", m_dBKL8)
                            .append ("BKL9", m_dBKL9)
                            .append ("usage", m_sUsage)
                            .append ("usageDesc", m_sUsageDesc)
                            .append ("trees", m_aTrees)
                            .append ("desc", m_sDesc)
                            .append ("sameAge", m_bSameAge)
                            .append ("oneLevel", m_bOneLevel)
                            .append ("TotSteh", m_aTotSteh)
                            .append ("TotLieg1", m_aTotLieg1)
                            .append ("TotLieg2", m_aTotLieg2)
                            .getToString ();
  }
  ...
  @Nonnull
  public final IExReservatBO getStichNrzR ()
  {
    return m_aStichNrzR;
  }

  @Nonnull
  final EChange setStichNrzR (@Nonnull final IExReservatBO aStichNrzR)
  {
  ...
  @Nonnull
  @ReturnsMutableObject
  public final ICommonsList <IExBiotopbaumBO> trees ()
  {
    return m_aTrees;
  }

  @Nonnull
  final EChange setTrees (@Nonnull final ICommonsList <IExBiotopbaumBO> aTrees)
  {
    ValueEnforcer.notNull (aTrees, "Trees");
    // Ensure the same implementation type
    final ICommonsList <IExBiotopbaumBO> aRealList = new CommonsArrayList <> (aTrees);
  ...
  @Nonnull
  @ReturnsMutableObject
  public final ICommonsList <IExStichprobeDeadwoodBO> totSteh ()
  {
    return m_aTotSteh;
  }

  @Nonnull
  final EChange setTotSteh (@Nonnull final ICommonsList <IExStichprobeDeadwoodBO> aTotSteh)
  {
    ValueEnforcer.notNull (aTotSteh, "TotSteh");
    // Ensure the same implementation type
    final ICommonsList <IExStichprobeDeadwoodBO> aRealList = new CommonsArrayList <> (aTotSteh);
  ...
  @Nonnull
  @ReturnsMutableObject
  public final ICommonsList <IExStichprobeDeadwoodBO> totLieg1 ()
  {
    return m_aTotLieg1;
  }

  @Nonnull
  final EChange setTotLieg1 (@Nonnull final ICommonsList <IExStichprobeDeadwoodBO> aTotLieg1)
  {
    ValueEnforcer.notNull (aTotLieg1, "TotLieg1");
    // Ensure the same implementation type
    final ICommonsList <IExStichprobeDeadwoodBO> aRealList = new CommonsArrayList <> (aTotLieg1);
  ...
  @Nonnull
  @ReturnsMutableObject
  public final ICommonsList <IExStichprobeDeadwoodBO> totLieg2 ()
  {
    return m_aTotLieg2;
  }

  @Nonnull
  final EChange setTotLieg2 (@Nonnull final ICommonsList <IExStichprobeDeadwoodBO> aTotLieg2)
  {
    ValueEnforcer.notNull (aTotLieg2, "TotLieg2");
    // Ensure the same implementation type
    final ICommonsList <IExStichprobeDeadwoodBO> aRealList = new CommonsArrayList <> (aTotLieg2);
