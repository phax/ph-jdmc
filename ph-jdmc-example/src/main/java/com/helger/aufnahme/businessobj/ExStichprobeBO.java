  ...
  implements IExStichprobeBO
{
  ...
  public ExStichprobeBO(final int nStichNr,
    ...
    @Nonnull
    final ICommonsList<IExBiotopbaumBO> aTrees,
    @Nonnull
    final String sDesc, final boolean bSameAge, final boolean bOneLevel,
    @Nonnull
    final ICommonsList<IExStichprobeDeadwoodBO> aTotSteh,
    @Nonnull
    final ICommonsList<IExStichprobeDeadwoodBO> aTotLieg1,
    @Nonnull
    final ICommonsList<IExStichprobeDeadwoodBO> aTotLieg2) {
