 ...
 */
public class ExBiotopbaumBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExBiotopbaumBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExBiotopbaumBO aValue,
  ...
  public ExBiotopbaumBO convertToNative (@Nonnull final IMicroElement aElement)
  {
    ...
    return new ExBiotopbaumBO (super.getStubObject (aElement),
                               nBBNr,
                               aPics,
                               aDate,
                               aType,
