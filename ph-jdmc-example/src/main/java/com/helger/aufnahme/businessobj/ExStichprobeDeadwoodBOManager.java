 ...
 * {@link com.helger.aufnahme.businessobj.ExStichprobeDeadwoodBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExStichprobeDeadwoodBOManager extends AbstractPhotonMapBasedWALDAO <IExStichprobeDeadwoodBO, ExStichprobeDeadwoodBO>
{

  public ExStichprobeDeadwoodBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExStichprobeDeadwoodBO.class, sFilename);
  }

  public ExStichprobeDeadwoodBOManager (@Nullable final String sFilename,
                                        @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExStichprobeDeadwoodBO> aInitSettings) throws DAOException
  {
                                                                     ...
                                                                     final int nBHD)
  {
    ...
    // Success audit
    AuditHelper.onAuditCreateSuccess (ExStichprobeDeadwoodBO.OT,
                                      aExStichprobeDeadwoodBO.getID (),
                                      eDoD,
                                      eTreeKind,
                                                     ...
                                                     final int nBHD)
  {
    ...
    // Success audit
    AuditHelper.onAuditModifySuccess (ExStichprobeDeadwoodBO.OT,
                                      "all",
                                      aExStichprobeDeadwoodBO.getID (),
                                      eDoD,
                                      eTreeKind,
   ...
   * {@link #markExStichprobeDeadwoodBOUndeleted(String)} method.
   * 
   * @param sExStichprobeDeadwoodBOID
   ...
   * {@link #markExStichprobeDeadwoodBODeleted(String)} method.
   * 
   * @param sExStichprobeDeadwoodBOID
