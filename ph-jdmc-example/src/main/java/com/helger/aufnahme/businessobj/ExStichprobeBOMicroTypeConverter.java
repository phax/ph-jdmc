  ...
  extends AbstractBusinessObjectMicroTypeConverter<ExStichprobeBO>
{
  ...
  private final Function<String, ? extends IExReservatBO> m_aResolverExReservatBO;

  public ExStichprobeBOMicroTypeConverter(@Nonnull Function<String, ? extends IExReservatBO> aResolverExReservatBO) {
