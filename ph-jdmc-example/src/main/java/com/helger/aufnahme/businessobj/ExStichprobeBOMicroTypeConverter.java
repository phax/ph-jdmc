 ...
 */
public class ExStichprobeBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExStichprobeBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExStichprobeBO aValue,
  ...
  public ExStichprobeBO convertToNative (@Nonnull final IMicroElement aElement)
  {
    ...
    return new ExStichprobeBO (super.getStubObject (aElement),
                               nStichNr,
                               aStichNrzR,
                               aPics,
                               aDate,
