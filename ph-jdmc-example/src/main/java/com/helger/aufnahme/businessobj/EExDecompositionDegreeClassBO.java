 ...
 */
public enum EExDecompositionDegreeClassBO implements IHasID <String>, IHasDisplayName
{
  CLASS0 ("c0", "Klasse 0"),
  CLASS1 ("c1", "Klasse 1"),
  CLASS2 ("c2", "Klasse 2"),
  ...
  @Nullable
  public static EExDecompositionDegreeClassBO getFromIDOrDefault (@Nullable final String sID,
                                                                  @Nullable final EExDecompositionDegreeClassBO eDefault)
  {
