 ...
 * {@link com.helger.aufnahme.businessobj.ExStichprobeBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExStichprobeBOManager extends AbstractPhotonMapBasedWALDAO <IExStichprobeBO, ExStichprobeBO>
{

  public ExStichprobeBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExStichprobeBO.class, sFilename);
  }

  public ExStichprobeBOManager (@Nullable final String sFilename,
                                @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExStichprobeBO> aInitSettings) throws DAOException
  {
   ...
   * @param aTrees
   *        Biotopbäume innerhalb Stichprobenpunkt. May not be
   *        <code>null</code>.
   * @param sDesc
   ...
   * @param aTotSteh
   *        Stehendes Totholz (Vollaufnahme) ab &gt;= 5cm BHD. May not be
   *        <code>null</code>.
   * @param aTotLieg1
   *        Liegendes Totholz (Line-intersect, Transekt 1) ab Mindestdurchmesser
   *        &gt;= 10 cm. May not be <code>null</code>.
   * @param aTotLieg2
   *        Liegendes Totholz (Line-intersect, Transekt 2) ab Mindestdurchmesser
   *        &gt;= 10 cm. May not be <code>null</code>.
  ...
  {
    // Create new object
    final ExStichprobeBO aExStichprobeBO = new ExStichprobeBO (nStichNr,
                                                               aStichNrzR,
                                                               aPics,
                                                               aDate,
                                                               nSize,
    ...
    // Success audit
    AuditHelper.onAuditCreateSuccess (ExStichprobeBO.OT,
                                      aExStichprobeBO.getID (),
                                      Integer.valueOf (nStichNr),
                                      aStichNrzR,
                                      aPics,
                                      aDate,
                                      ...
                                      sHanglage,
                                      sGesellschaft,
                                      Double.valueOf (dBKL0),
                                      Double.valueOf (dBKL1),
                                      Double.valueOf (dBKL2),
                                      Double.valueOf (dBKL3),
                                      Double.valueOf (dBKL4),
                                      Double.valueOf (dBKL5),
                                      Double.valueOf (dBKL6),
                                      Double.valueOf (dBKL7),
                                      Double.valueOf (dBKL8),
                                      Double.valueOf (dBKL9),
                                      sUsage,
                                      sUsageDesc,
                                      aTrees,
                                      sDesc,
                                      Boolean.valueOf (bSameAge),
                                      Boolean.valueOf (bOneLevel),
                                      aTotSteh,
                                      aTotLieg1,
                                      aTotLieg2);
                                             ...
                                             @Nonnull final ICommonsList <IExStichprobeDeadwoodBO> aTotLieg2)
  {
    ...
    // Success audit
    AuditHelper.onAuditModifySuccess (ExStichprobeBO.OT,
                                      "all",
                                      aExStichprobeBO.getID (),
                                      Integer.valueOf (nStichNr),
                                      aStichNrzR,
   ...
   * and can be restored using the {@link #markExStichprobeBOUndeleted(String)}
   * method.
   * 
   * @param sExStichprobeBOID
   ...
   * {@link #markExStichprobeBODeleted(String)} method.
   * 
   * @param sExStichprobeBOID
