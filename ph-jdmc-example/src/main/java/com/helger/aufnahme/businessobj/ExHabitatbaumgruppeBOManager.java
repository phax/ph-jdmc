 ...
 * {@link com.helger.aufnahme.businessobj.ExHabitatbaumgruppeBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExHabitatbaumgruppeBOManager extends AbstractPhotonMapBasedWALDAO <IExHabitatbaumgruppeBO, ExHabitatbaumgruppeBO>
{

  public ExHabitatbaumgruppeBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExHabitatbaumgruppeBO.class, sFilename);
  }

  public ExHabitatbaumgruppeBOManager (@Nullable final String sFilename,
                                       @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExHabitatbaumgruppeBO> aInitSettings) throws DAOException
  {
   ...
   *        Größe (in m²).
   * @param bOnlyBB
   *        Habitatbaumgruppe NUR aus schon kartierten Biotopbäumen oder auch
   *        aus anderen Bäumen bestehend.
   * @param sBeschreibung
  ...
  {
    // Create new object
    final ExHabitatbaumgruppeBO aExHabitatbaumgruppeBO = new ExHabitatbaumgruppeBO (nHBGNr,
                                                                                    aPics,
                                                                                    aHBGzBB,
                                                                                    aDate,
                                                                                    sStandort,
    ...
    // Success audit
    AuditHelper.onAuditCreateSuccess (ExHabitatbaumgruppeBO.OT,
                                      aExHabitatbaumgruppeBO.getID (),
                                      Integer.valueOf (nHBGNr),
                                      aPics,
                                      aHBGzBB,
                                      aDate,
                                      sStandort,
                                      Boolean.valueOf (bOneLevel),
                                      Boolean.valueOf (bLight),
                                      Boolean.valueOf (bClosedCrown),
                                      Boolean.valueOf (bNoSun),
                                      Boolean.valueOf (bHomogen),
                                      eExposition,
                                      sHanglage,
                                      Integer.valueOf (nAreaSize),
                                      Boolean.valueOf (bOnlyBB),
                                      sBeschreibung);
                                                    ...
                                                    @Nonnull final String sBeschreibung)
  {
    ...
    // Success audit
    AuditHelper.onAuditModifySuccess (ExHabitatbaumgruppeBO.OT,
                                      "all",
                                      aExHabitatbaumgruppeBO.getID (),
                                      Integer.valueOf (nHBGNr),
                                      aPics,
   ...
   * {@link #markExHabitatbaumgruppeBOUndeleted(String)} method.
   * 
   * @param sExHabitatbaumgruppeBOID
   ...
   * {@link #markExHabitatbaumgruppeBODeleted(String)} method.
   * 
   * @param sExHabitatbaumgruppeBOID
