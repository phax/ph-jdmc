 ...
 */
public class ExBiotopbaumDeadwoodBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExBiotopbaumDeadwoodBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExBiotopbaumDeadwoodBO aValue,
  ...
  @Nonnull
  public ExBiotopbaumDeadwoodBO convertToNative (@Nonnull final IMicroElement aElement)
  {
