 ...
 */
public class ExStichprobeDeadwoodBOMicroTypeConverter extends AbstractBusinessObjectMicroTypeConverter <ExStichprobeDeadwoodBO>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final ExStichprobeDeadwoodBO aValue,
