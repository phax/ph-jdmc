 ...
 * {@link com.helger.aufnahme.businessobj.ExLeergutBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExLeergutBOManager extends AbstractPhotonMapBasedWALDAO <IExLeergutBO, ExLeergutBO>
{

  public ExLeergutBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExLeergutBO.class, sFilename);
  }

  public ExLeergutBOManager (@Nullable final String sFilename,
                             @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExLeergutBO> aInitSettings) throws DAOException
  {
   ...
   * and can be restored using the {@link #markExLeergutBOUndeleted(String)}
   * method.
   * 
   * @param sExLeergutBOID
   ...
   * {@link #markExLeergutBODeleted(String)} method.
   * 
   * @param sExLeergutBOID
