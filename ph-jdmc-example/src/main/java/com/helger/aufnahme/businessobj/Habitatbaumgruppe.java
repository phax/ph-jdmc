...
/**
 * <p>Default implementation of {@link com.helger.aufnahme.businessobj.IHabitatbaumgruppe}</p>
  ...
  implements IHabitatbaumgruppe
{
  ...
  protected Habitatbaumgruppe(final StubObject aStubObject, final int nHBGNr,
    @Nonnull
    @Nonempty
    final ICommonsList<File> aPics,
    @Nonnull
