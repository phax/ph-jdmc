 ...
 * {@link com.helger.aufnahme.businessobj.ExBestandBO}
 * </p>
 * <p>
 ...
 */
@ThreadSafe
public class ExBestandBOManager extends AbstractPhotonMapBasedWALDAO <IExBestandBO, ExBestandBO>
{

  public ExBestandBOManager (@Nullable final String sFilename) throws DAOException
  {
    super (ExBestandBO.class, sFilename);
  }

  public ExBestandBOManager (@Nullable final String sFilename,
                             @Nonnull final AbstractMapBasedWALDAO.InitSettings <ExBestandBO> aInitSettings) throws DAOException
  {
   ...
   * @param sTotStehBesch
   *        Beschreibung Totholz stehend (geklumpt, Art, Herkunft,
   *        Zersetzungsgrade). May not be <code>null</code>.
   * @param eTotLieg
   *        Schätzung Totholz liegend. May not be <code>null</code>.
   * @param sTotLiegBesch
   *        Beschreibung Totholz liegend (geklumpt, Art, Herkunft,
   *        Zersetzungsgrade). May not be <code>null</code>.
  ...
  {
    // Create new object
    final ExBestandBO aExBestandBO = new ExBestandBO (nBNr,
                                                      aPics,
                                                      aDate,
                                                      sVerortung,
                                                      aBZHBG,
    ...
    // Success audit
    AuditHelper.onAuditCreateSuccess (ExBestandBO.OT,
                                      aExBestandBO.getID (),
                                      Integer.valueOf (nBNr),
                                      aPics,
                                      aDate,
                                      sVerortung,
                                      aBZHBG,
                                      ...
                                      sUsageDescription,
                                      sGesellschaft,
                                      Boolean.valueOf (bKronenschluss),
                                      Boolean.valueOf (bLightWoods),
                                      Boolean.valueOf (bUnterwuchs),
                                      eTotSteh,
                                      sTotStehBesch,
                                      eTotLieg,
                                      sTotLiegBesch);
                                          ...
                                          @Nonnull final String sTotLiegBesch)
  {
    ...
    // Success audit
    AuditHelper.onAuditModifySuccess (ExBestandBO.OT,
                                      "all",
                                      aExBestandBO.getID (),
                                      Integer.valueOf (nBNr),
                                      aPics,
   ...
   * and can be restored using the {@link #markExBestandBOUndeleted(String)}
   * method.
   * 
   * @param sExBestandBOID
   ...
   * {@link #markExBestandBODeleted(String)} method.
   * 
   * @param sExBestandBOID
