  ...
  implements IMicroTypeConverter<Bestand>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement(@Nonnull final Bestand aValue, @Nullable final String sNamespaceURI, @Nonnull final String sTagName) {
  ...
  @Nonnull
  public Bestand convertToNative(@Nonnull final IMicroElement aElement) {
    ...
    final EStockType eStockTypeOpt = EStockType.getFromIDOrNull(aElement.getAttributeValue(ATTR_STOCKTYPEOPT));
    ...
    return new Bestand(nBNr, aPics, aDate, sVerortung, aBZHBG, aAreaSize, aAreaSizeLong, aAreaSizeFloat, aAreaSizeDouble, sBeschreib, bSameAge, bOneLevel, eStockType, eStockTypeOpt, sUsageDescription, sGesellschaft, bKronenschluss, bLightWoods, bUnterwuchs, eTotSteh, sTotStehBesch, eTotLieg, sTotLiegBesch);
  }
}
