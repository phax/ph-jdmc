...
/**
 * <p>
 * Default implementation of {@link com.helger.aufnahme.simple.IBestand}
 * </p>
 * <p>
 ...
 */
@NotThreadSafe
public class Bestand implements IBestand
{
  ...
  public int hashCode ()
  {
    return new HashCodeGenerator (this).append (m_nBNr)
                                       .append (m_aPics)
                                       .append (m_aDate)
                                       .append (m_sVerortung)
                                       .append (m_aBZHBG)
                                       .append (m_aAreaSize)
                                       .append (m_aAreaSizeLong)
                                       .append (m_aAreaSizeFloat)
                                       .append (m_aAreaSizeDouble)
                                       .append (m_sBeschreib)
                                       .append (m_bSameAge)
                                       .append (m_bOneLevel)
                                       .append (m_eStockType)
                                       .append (m_eStockTypeOpt)
                                       .append (m_sUsageDescription)
                                       .append (m_sGesellschaft)
                                       .append (m_bKronenschluss)
                                       .append (m_bLightWoods)
                                       .append (m_bUnterwuchs)
                                       .append (m_eTotSteh)
                                       .append (m_sTotStehBesch)
                                       .append (m_eTotLieg)
                                       .append (m_sTotLiegBesch)
                                       .getHashCode ();
  }
  ...
  {
    return new ToStringGenerator (this).append ("BNr", m_nBNr)
                                       .append ("pics", m_aPics)
                                       .append ("date", m_aDate)
