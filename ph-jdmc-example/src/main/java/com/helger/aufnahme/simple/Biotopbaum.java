...
/**
 * <p>
 * Default implementation of {@link com.helger.aufnahme.simple.IBiotopbaum}
 * </p>
 * <p>
 ...
 */
@NotThreadSafe
public class Biotopbaum implements IBiotopbaum
{
  ...
  public int hashCode ()
  {
    return new HashCodeGenerator (this).append (m_nBBNr)
                                       .append (m_aPics)
                                       .append (m_aDate)
                                       .append (m_aType)
                                       .append (m_sLocation)
                                       ...
                                       .append (m_sHanglage)
                                       .append (m_bEinschichtig)
                                       .append (m_bSolitary)
                                       .append (m_bLightLocation)
                                       ...
                                       .append (m_aTrunk)
                                       .append (m_eVitality)
                                       .append (m_aSpecialStructure)
                                       .append (m_sOtherSpecial)
                                       .append (m_bAspirant)
                                       .append (m_sAspirantDesc)
                                       .append (m_bMarked)
                                       .append (m_sMarkedDesc)
                                       .append (m_aDeadwoodCats)
                                       .append (m_aDeadwoodDoD)
                                       .getHashCode ();
  }
  ...
  public String toString ()
  {
    return new ToStringGenerator (this).append ("BBNr", m_nBBNr)
                                       ...
                                       .append ("einschichtig", m_bEinschichtig)
                                       .append ("solitary", m_bSolitary)
                                       .append ("lightLocation", m_bLightLocation)
                                       .append ("closedCrown", m_bClosedCrown)
                                       .append ("noSun", m_bNoSun)
                                       .append ("ueberSun", m_bUeberSun)
                                       .append ("homogene", m_bHomogene)
                                       .append ("Beschreibung", m_sBeschreibung)
                                       .append ("treeKind", m_eTreeKind)
                                       .append ("caves", m_aCaves)
                                       .append ("trunk", m_aTrunk)
                                       .append ("vitality", m_eVitality)
                                       .append ("specialStructure", m_aSpecialStructure)
                                       .append ("otherSpecial", m_sOtherSpecial)
                                       .append ("aspirant", m_bAspirant)
                                       .append ("aspirantDesc", m_sAspirantDesc)
                                       .append ("marked", m_bMarked)
                                       .append ("markedDesc", m_sMarkedDesc)
                                       .append ("deadwoodCats", m_aDeadwoodCats)
                                       .append ("deadwoodDoD", m_aDeadwoodDoD)
                                       .getToString ();
  }
