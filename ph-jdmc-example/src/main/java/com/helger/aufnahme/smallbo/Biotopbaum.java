...
/**
 * <p>Default implementation of {@link com.helger.aufnahme.smallbo.IBiotopbaum}</p>
  ...
  implements IBiotopbaum
{
  ...
  public Biotopbaum(final int nBBNr,
    ...
    @Nonnull
    @Nonempty
    final ICommonsList<EBiotopbaumType> aType,
    @Nullable
    ...
    @Nonnull
    final ICommonsList<ESpecialStructure> aSpecialStructure,
    @Nullable
