 ...
 */
public enum EDecompositionDegreeClass implements IHasID <String>, IHasDisplayName
{
  CLASS0 ("c0", "Klasse 0"),
  CLASS1 ("c1", "Klasse 1"),
  CLASS2 ("c2", "Klasse 2"),
  ...
  @Nullable
  public static EDecompositionDegreeClass getFromIDOrDefault (@Nullable final String sID,
                                                              @Nullable final EDecompositionDegreeClass eDefault)
  {
