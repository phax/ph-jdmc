 ...
 * {@link com.helger.aufnahme.businessobj.ExBestandBO} This class was initially
...
public final class ExBestandBOTest
{
  ...
  {
    ExBestandBO x = new ExBestandBO (8,
    ...
    ExBestandBO y = new ExBestandBO (8,
                                     new CommonsArrayList <> (new File ("file.txt")),
                                     PDTFactory.getCurrentLocalDate (),
                                     "foo",
                                     new CommonsArrayList <> (new ExHabitatbaumgruppeBO (8,
    ...
    x.setBZHBG (new CommonsArrayList <> (new ExHabitatbaumgruppeBO (8,
                                                                    new CommonsArrayList <> (new File ("file.txt")),
                                                                    new CommonsArrayList <> (new ExBiotopbaumBO (8,
                                                                                                                 new CommonsArrayList <> (new File ("file.txt")),
                                                                                                                 PDTFactory.getCurrentLocalDate (),
