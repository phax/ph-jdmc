 ...
 * {@link com.helger.aufnahme.businessobj.ExHabitatbaumgruppeBO} This class was
...
public final class ExHabitatbaumgruppeBOTest
{
  ...
  {
    ExHabitatbaumgruppeBO x = new ExHabitatbaumgruppeBO (8,
    ...
    ExHabitatbaumgruppeBO y = new ExHabitatbaumgruppeBO (8,
                                                         new CommonsArrayList <> (new File ("file.txt")),
                                                         new CommonsArrayList <> (new ExBiotopbaumBO (8,
                                                                                                      new CommonsArrayList <> (new File ("file.txt")),
                                                                                                      PDTFactory.getCurrentLocalDate (),
    ...
    x.setHBGzBB (new CommonsArrayList <> (new ExBiotopbaumBO (8,
                                                              new CommonsArrayList <> (new File ("file.txt")),
                                                              PDTFactory.getCurrentLocalDate (),
                                                              new CommonsArrayList <> (EExBiotopbaumTypeBO.TOTHOLZ),
                                                              "foo",
