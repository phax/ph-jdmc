 ...
 * {@link com.helger.aufnahme.businessobj.ExStichprobeBO} This class was
...
public final class ExStichprobeBOTest
{
  ...
  {
    ExStichprobeBO x = new ExStichprobeBO (8,
                                           new ExReservatBO (8, "foo", 8),
                                           ...
                                           "foo",
                                           "foo",
                                           new CommonsArrayList <> (new ExBiotopbaumBO (8,
                                                                                        new CommonsArrayList <> (new File ("file.txt")),
                                                                                        PDTFactory.getCurrentLocalDate (),
                                                                                        ...
                                                                                        new CommonsArrayList <> (new ExCaveTypeBO (EExCaveClassBO.ONE,
                                                                                                                                   EExCaveTypeBO._1)),
                                                                                        new CommonsArrayList <> (new ExTrunkSizeBO (8,
                                                                                                                                    EExTreeHeightBO.ONE)),
                                                                                        EExVitalityBO.ONE,
                                                                                        ...
                                                                                        true,
                                                                                        "foo",
                                                                                        new CommonsArrayList <> (new ExBiotopbaumDeadwoodBO (EExDeadwoodCategoryBO.CLASS1,
                                                                                                                                             true,
                                                                                                                                             8,
                                                                                                                                             8)),
                                           ...
                                           true,
                                           true,
                                           new CommonsArrayList <> (new ExStichprobeDeadwoodBO (EExDecompositionDegreeClassBO.CLASS0,
                                                                                                EExTreeKindBO.Bergahorn,
                                                                                                8,
                                                                                                8)),
                                           new CommonsArrayList <> (new ExStichprobeDeadwoodBO (EExDecompositionDegreeClassBO.CLASS0,
    ...
    ExStichprobeBO y = new ExStichprobeBO (8,
                                           new ExReservatBO (8, "foo", 8),
                                           new CommonsArrayList <> (new File ("file.txt")),
                                           PDTFactory.getCurrentLocalDate (),
                                           8,
    ...
    x.setTrees (new CommonsArrayList <> (new ExBiotopbaumBO (8,
                                                             new CommonsArrayList <> (new File ("file.txt")),
                                                             PDTFactory.getCurrentLocalDate (),
                                                             new CommonsArrayList <> (EExBiotopbaumTypeBO.TOTHOLZ),
                                                             "foo",
    ...
    x.setTotSteh (new CommonsArrayList <> (new ExStichprobeDeadwoodBO (EExDecompositionDegreeClassBO.CLASS0,
                                                                       EExTreeKindBO.Bergahorn,
                                                                       8,
                                                                       8)));
    x.setTotLieg1 (new CommonsArrayList <> (new ExStichprobeDeadwoodBO (EExDecompositionDegreeClassBO.CLASS0,
                                                                        EExTreeKindBO.Bergahorn,
                                                                        8,
                                                                        8)));
    x.setTotLieg2 (new CommonsArrayList <> (new ExStichprobeDeadwoodBO (EExDecompositionDegreeClassBO.CLASS0,
                                                                        EExTreeKindBO.Bergahorn,
                                                                        8,
                                                                        8)));
    // XML conversion conversion cannot be checked because custom
    // MicroTypeConverter registration would be needed
