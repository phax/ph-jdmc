...
/**
 * This is the test class for class {@link com.helger.aufnahme.small.Stichprobe}
...
public final class StichprobeTest
{
  ...
  {
    Stichprobe x = new Stichprobe (8,
                                   new Reservat (8, "foo", 8),
                                   ...
                                   "foo",
                                   "foo",
                                   new CommonsArrayList <> (new Biotopbaum (8,
                                                                            new CommonsArrayList <> (new File ("file.txt")),
                                                                            PDTFactory.getCurrentLocalDate (),
                                                                            ...
                                                                            "foo",
                                                                            ETreeKind.Bergahorn,
                                                                            new CommonsArrayList <> (new CaveType (ECaveClass.ONE,
                                                                                                                   ECaveType._1)),
                                                                            ...
                                                                            true,
                                                                            "foo",
                                                                            new CommonsArrayList <> (new BiotopbaumDeadwood (EDeadwoodCategory.CLASS1,
                                                                                                                             true,
                                                                                                                             8,
                                                                                                                             8)),
                                   ...
                                   true,
                                   true,
                                   new CommonsArrayList <> (new StichprobeDeadwood (EDecompositionDegreeClass.CLASS0,
                                                                                    ETreeKind.Bergahorn,
                                                                                    8,
                                                                                    8)),
                                   new CommonsArrayList <> (new StichprobeDeadwood (EDecompositionDegreeClass.CLASS0,
    ...
    Assert.assertFalse (x.setTrees (new CommonsArrayList <> (new Biotopbaum (8,
                                                                             new CommonsArrayList <> (new File ("file.txt")),
                                                                             PDTFactory.getCurrentLocalDate (),
                                                                             new CommonsArrayList <> (EBiotopbaumType.TOTHOLZ),
                                                                             "foo",
    ...
    Assert.assertFalse (x.setTotSteh (new CommonsArrayList <> (new StichprobeDeadwood (EDecompositionDegreeClass.CLASS0,
                                                                                       ETreeKind.Bergahorn,
                                                                                       8,
                                                                                       8)))
                         .isChanged ());
    Assert.assertFalse (x.setTotLieg1 (new CommonsArrayList <> (new StichprobeDeadwood (EDecompositionDegreeClass.CLASS0,
                                                                                        ETreeKind.Bergahorn,
                                                                                        8,
                                                                                        8)))
                         .isChanged ());
    Assert.assertFalse (x.setTotLieg2 (new CommonsArrayList <> (new StichprobeDeadwood (EDecompositionDegreeClass.CLASS0,
                                                                                        ETreeKind.Bergahorn,
                                                                                        8,
                                                                                        8)))
                         .isChanged ());
