...
public final class BestandTest
{
  ...
  public void testDefaultCtor ()
  {
    ...
    Assert.assertNull (x.getAreaSizeDouble ());
  ...
  public void testSetterAndGetter ()
  {
    ...
    Assert.assertFalse (x.setBZHBG (new CommonsArrayList <> (new Habitatbaumgruppe (8,
                                                                                    new CommonsArrayList <> (new File ("file.txt")),
                                                                                    new CommonsArrayList <> (new Biotopbaum (8,
                                                                                                                             new CommonsArrayList <> (new File ("file.txt")),
                                                                                                                             PDTFactory.getCurrentLocalDate (),
