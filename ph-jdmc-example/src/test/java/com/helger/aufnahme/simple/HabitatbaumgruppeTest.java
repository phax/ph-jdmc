 ...
 * {@link com.helger.aufnahme.simple.Habitatbaumgruppe} This class was initially
...
public final class HabitatbaumgruppeTest
{
  ...
  {
    Habitatbaumgruppe x = new Habitatbaumgruppe (8,
    ...
    Habitatbaumgruppe y = new Habitatbaumgruppe (8,
                                                 new CommonsArrayList <> (new File ("file.txt")),
                                                 new CommonsArrayList <> (new Biotopbaum (8,
                                                                                          new CommonsArrayList <> (new File ("file.txt")),
                                                                                          PDTFactory.getCurrentLocalDate (),
    ...
    Assert.assertFalse (x.setHBGzBB (new CommonsArrayList <> (new Biotopbaum (8,
                                                                              new CommonsArrayList <> (new File ("file.txt")),
                                                                              PDTFactory.getCurrentLocalDate (),
                                                                              new CommonsArrayList <> (EBiotopbaumType.TOTHOLZ),
                                                                              "foo",
