 ...
 * {@link com.helger.aufnahme.simple.Biotopbaum} This class was initially
...
public final class BiotopbaumTest
{
  ...
  public void testSetterAndGetter ()
  {
    ...
    Assert.assertFalse (x.setDeadwoodCats (new CommonsArrayList <> (new BiotopbaumDeadwood (EDeadwoodCategory.CLASS1, true, 8, 8)))
                         .isChanged ());
    Assert.assertFalse (x.setDeadwoodDoD (new CommonsArrayList <> (new BiotopbaumDecompositionDegree (EDecompositionDegreeClass.CLASS0,
                                                                                                      true,
                                                                                                      8,
                                                                                                      8)))
                         .isChanged ());
